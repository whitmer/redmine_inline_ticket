...
The only reason I don't render the tickets as we go
and instead do render_tickets at the end is so I can
cut down on the number of active_record finds and just
stash the ids with the call to ticket.
